...
class ValidLoginTest < UserLoginTest
  ...
  test "login with username, followed by logout, and similating a second logout from another window" do
    ...
    assert_select "a[href=?]", user_path(@test_user.username), count: 1, text: "Your profile"
    ...
    # STEP 4. Log out
    get logout_path # delete logout_path
    ...
    get logout_path # delete logout_path  # aqui en el entorno de pruebas si me funciona correctamente el redirect para el segundo logout con delete, pero no en el entorno de desarrollo ni production con el navegador real
    assert_response :see_other
    assert_redirected_to root_url
    follow_redirect!
    assert_template "static_pages/home"
  ...
  test "login with email address, followed by logout, and similating a second logout from another window" do
    # STEP 1. Visit login page
    get login_path
    assert_template "sessions/new"
